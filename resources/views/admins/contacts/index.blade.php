<x-admin-layout>
    ...
    <div>
        <div class="font-bold text-2xl">Quản lý liên hệ</div>
                            ...
                            <table class="min-w-full divide-y divide-gray-200 dark:divide-neutral-700">
                                ...
                                @foreach($contacts as $contact)
                                    <tr class="odd:bg-white even:bg-gray-50">
                                        <td class="px-4 py-3 text-sm text-gray-800">{{ $contact->fullname }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-800">{{ $contact->phone }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-800">{{ $contact->type }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-800">{{ $contact->datetime }}</td>
                                        <td class="px-4 py-3 text-sm text-gray-800">{{ $contact->description }}</td>
